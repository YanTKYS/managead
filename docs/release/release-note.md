...
## v0.9.6
### Title
ManageAdTool v0.9.6（打鍵テスト反映・参照UI再調整）

### Note
- **打鍵テスト結果を記録**: 初回〜3回目報告の成功・指摘事項を `docs/operation/test-record-v0.9.6.md` に記録した。3回目報告では ServiceMode 選択後のメイン画面遷移、部署削除、`v0.4.2` 表示削除が成功した。
